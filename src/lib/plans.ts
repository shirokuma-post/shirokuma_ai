...
export const PLANS = {
  free: {
    ...
    styles: ["mix", "paradigm_break", "provocative", "boyaki", "yueki"] as PostStyle[],
  ...
  pro: {
    ...
    maxScheduleTimes: 10,
    multiSns: false,              // 1つのSNSのみ
    styles: ["mix", "paradigm_break", "provocative", "flip", "poison_story", "boyaki", "yueki", "jitsuwa", "gyakubari", "ai_optimized"] as PostStyle[],
