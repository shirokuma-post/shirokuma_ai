...
export default function SchedulePage() {
  ...
  function canUseTarget(targetId: "x" | "threads" | "instagram"): boolean {
    if (targetId === "instagram") return isMultiSns; // Business only
                ...
                <div key={i} className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className={"text-xs px-2 py-0.5 rounded-full font-medium " + (slot.target === "x" ? "bg-gray-100 text-gray-700" : slot.target === "threads" ? "bg-purple-50 text-purple-700" : slot.target === "instagram" ? "bg-gradient-to-r from-yellow-100 via-pink-100 to-purple-100 text-pink-700" : "bg-blue-50 text-blue-700")}>{targetLabel}</span>
